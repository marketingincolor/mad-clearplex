...
function mic_register_settings()
{
    ...
    $field_args = array(
      ...
      'id'        => 'twitter_link',
      'name'      => 'twitter_link',
      'desc'      => 'Twitter Link - Example: https://twitter.com/username',
      'std'       => '',
    ...
    $field_args = array(
      ...
      'id'        => 'facebook_link',
      'name'      => 'facebook_link',
      'desc'      => 'Facebook Link - Example: https://facebook.com/username',
      'std'       => '',
    ...
    $field_args = array(
      ...
      'id'        => 'gplus_link',
      'name'      => 'gplus_link',
      'desc'      => 'Google+ Link - Example: https://plus.google.com/user_id',
      'std'       => '',
    ...
    $field_args = array(
      ...
      'id'        => 'linkedin_link',
      'name'      => 'linkedin_link',
      'desc'      => 'LinkedIn Link - Example: https://linkedin.com/in/username',
      'std'       => '',
    ...
    $field_args = array(
      ...
      'id'        => 'instagram_link',
      'name'      => 'instagram_link',
      'desc'      => 'Instagram Link - Example: https://instagram.com/username',
      'std'       => '',
      'label_for' => 'instagram_link',
      'class'     => 'css_class'
    );

    add_settings_field( 'instagram_link', 'Instagram', 'mic_display_setting', 'mic_theme_options.php', 'mic_text_section', $field_args );
